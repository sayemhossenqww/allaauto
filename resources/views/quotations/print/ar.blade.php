        ...
        <div style="margin-top: 1rem; margin-bottom: 0.2rem;text-align: center !important;">
            ...
            @if ($settings->logo)
                <div style="padding-right: 1rem;padding-left: 1rem;margin-bottom: 1rem; width:250px!important">
                    <div style=" width:400px!important"> <img src="{{ asset('images/newlogo.jpg') }}" alt="Logo" />
                    <!-- <div style=" width:400px!important"> <img src="{{ asset('images/newlogo.jpg') }}" style="width:300px" alt="Logo" /> -->
                    </div>
                </div>
            @else
