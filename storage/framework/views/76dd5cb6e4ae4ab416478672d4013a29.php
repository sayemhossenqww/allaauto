...
<?php endif; ?>
                ...
                <div class="col-auto mt-3">
                    <form action="<?php echo e(route('products.import')); ?>" method="POST" enctype="multipart/form-data" class="d-inline">
                        <?php echo csrf_field(); ?>
                ...
                <div class="col-auto mt-3">
                    <a href="<?php echo e(route('products.export')); ?>" class="btn btn-success">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Alla_Auto_Parts\www\resources\views/products/index.blade.php ENDPATH**/ ?>