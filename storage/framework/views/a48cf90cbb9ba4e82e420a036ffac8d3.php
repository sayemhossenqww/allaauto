...
<?php else: ?>
    ...
    <!-- Store Name -->
      <div style="text-align: left; font-size: 1.1rem;">
          ...
          <div>
              ...
              <!-- <p class="m-0">Processed By: <?php echo e($order->user->name); ?></p> -->
          </div>
      </div>
      <div>
    ...
    <div class="customer-info">
        ...
        <p class="m-0"><strong>Name:</strong> <?php echo e($order->customer->name); ?></p>
        <!-- <p class="m-0"><strong>Email:</strong> <?php echo e($order->customer->email); ?></p> -->
        <p class="m-0"><strong>Mobile:</strong> <?php echo e($order->customer->mobile); ?></p>
        <p class="m-0"><strong>City:</strong> <?php echo e($order->customer->city); ?></p>
    </div>
<?php endif; ?>
...
<div class="logos">
  ...
  <img src="<?php echo e(asset('images/landRover.png')); ?>" width="140" height="140" alt="">
...
</script><?php /**PATH /Users/sayemh/Downloads/Alla_Auto_Parts/www/resources/views/orders/print/en.blade.php ENDPATH**/ ?>